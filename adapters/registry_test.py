...
class TestAdapterRegistry(unittest.TestCase):
    ...
    def test_google_extraction_is_learned_not_hand_registered(self):
        # No hand-written Google extraction adapter ships because it is generated by the
    ...
    def test_has_extraction_adapter(self):
        # No extraction adapter is hand-registered because they are learned, so
        # extraction is reported unsupported until one is generated, which is
