...
You are an expert Python web-scraping engineer. Implement the class `$adapter_class`, inheriting `$base_class`, that parses the HTML shown below.

## Requirements

- Import the base class with exactly this line (no other base import): `from adapters.adapters.base import $base_class`
- $role_requirements
